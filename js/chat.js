...
async function openChat(chatId, preloadedData) {
  ...
  // Simpan state history untuk tombol back HP
...
function closeChat() {
  ...
  // Bersihkan inline style & hapus class chat-open
...
// ============================================================================
// PREVIEW FOTO + NAVIGASI MOBILE (FIX TOMBOL BACK)
// ============================================================================
