...
// ============================================================================
// FUNGSI KOMPRES GAMBAR (Aman & Ringan untuk Firestore)
// ============================================================================
...
onAuthStateChanged(auth, async (user) => {
  ...
  // Muat Foto Profil dari Firestore
  try {
...
// ============================================================================
// BUKA & TUTUP OBROLAN + PESAN
// ============================================================================

async function openChat(chatId, preloadedData) {
  // Jika sebelumnya belum membuka chat, tambahkan state history baru untuk navigasi tombol Back HP
  if (!currentChatId) {
...
// ============================================================================
// PREVIEW FOTO + NAVIGASI MOBILE (NAVIGASI BACK FIX)
// ============================================================================
...
document.getElementById("backBtn").addEventListener("click", () => {
  if (history.state && history.state.inChat) {
    history.back(); // Panggil back history agar state selaras
  } else {
    closeChat();
  }
});

// KETIKA TOMBOL BACK bawaan HP / SWIPE BACK DITEKAN
window.addEventListener("popstate", () => {
  if (currentChatId) {
    closeChat(); // Tutup obrolan saja, jangan keluar dari web/APK
  }
});
